...
export const getCategoriasByDepartamentoRoute = (app) => {
    app.get('/categorias/departamento/:departamentoId', {
        schema: {
        ...
        else if (depNome.includes('segurança') ||
        ...
        else if (depNome.includes('meio ambiente') ||
