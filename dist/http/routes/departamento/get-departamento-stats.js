...
export const getDepartamentoStatsRoute = (app) => {
    app.get('/departamentos/:id/stats', {
        schema: {
            params: z.object({
                id: z.string().uuid(),
            }),
        ...
        try {
            ...
            const [resolvidos] = await db
                ...
                .from(chamados)
                .where(and(eq(chamados.cha_departamento, id), isNotNull(chamados.cha_data_fechamento)));
            ...
            const [emAndamento] = await db
                ...
                .from(chamados)
                .where(and(eq(chamados.cha_departamento, id), isNotNull(chamados.cha_responsavel), isNull(chamados.cha_data_fechamento)));
            ...
            const [pendentes] = await db
                ...
                .from(chamados)
                .where(and(eq(chamados.cha_departamento, id), isNull(chamados.cha_responsavel), isNull(chamados.cha_data_fechamento)));
            const result = {
                total: stats?.total || 0,
