...
export const cidadesRoute = (app) => {
    ...
    app.put('/cidades/:id', {
        ...
        try {
            ...
            const updateData = {};
            if (nome !== undefined)
                updateData.cid_nome = nome;
            if (estado !== undefined)
                updateData.cid_estado = estado;
            if (padrao !== undefined)
                updateData.cid_padrao = padrao;
            if (ativo !== undefined)
                updateData.cid_ativo = ativo;
    ...
    app.delete('/cidades/:id', {
        ...
        try {
            ...
            if (error?.cause?.code === '23503' ||
                ...
                return reply.status(400).send({
                    message: 'Não é possível remover esta cidade porque ela possui registros vinculados (administradores, departamentos, funcionários ou chamados). Remova primeiro os registros relacionados.',
