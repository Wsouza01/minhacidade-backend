...
export const deleteAdministradoresRoute = (app) => {
    app.delete('/administradores/:id', {
        schema: {
            params: z.object({
                id: z.string().uuid(),
            }),
        ...
        try {
            ...
            if (error?.cause?.code === '23503' ||
                ...
                return reply.status(400).send({
                    message: 'Não é possível remover este administrador porque ele possui registros vinculados. Remova primeiro os registros relacionados.',
