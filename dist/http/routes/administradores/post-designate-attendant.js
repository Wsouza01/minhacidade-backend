...
export const designateAttendantRoute = (app) => {
    app.post('/admin/funcionarios/:funcionarioId/designate-attendant', {
        schema: {
            params: z.object({
            ...
            description: 'Designa um funcionário como o atendente principal da cidade.',
        ...
        try {
            ...
            if (admin.cidadeId &&
                ...
                return reply.status(403).send({
                    message: 'Você não tem permissão para modificar funcionários de outra cidade.',
                });
            }
            ...
            await db.transaction(async (tx) => {
                ...
                await tx
                    ...
                    .where(and(eq(schema.funcionarios.cid_id, cidadeDoFuncionario), eq(schema.funcionarios.fun_tipo, 'atendente'), ne(schema.funcionarios.fun_id, funcionarioId)));
            ...
            return reply.status(200).send({
                message: 'Funcionário designado como atendente da cidade com sucesso.',
            });
        }
        catch (error) {
