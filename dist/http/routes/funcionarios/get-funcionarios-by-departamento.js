...
export const getFuncionariosByDepartamentoRoute = (app) => {
    app.get('/funcionarios/departamento/:id', {
        schema: {
        ...
        try {
            ...
            const results = await db
                ...
                .from(funcionarios)
                .where(and(eq(funcionarios.dep_id, departamentoId), eq(funcionarios.fun_tipo, 'servidor')))
                .leftJoin(chamadosCountSubquery, eq(funcionarios.fun_id, chamadosCountSubquery.funcionarioId));
