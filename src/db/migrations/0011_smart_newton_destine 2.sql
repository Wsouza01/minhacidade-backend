...
ALTER TABLE "funcionario" ADD COLUMN "fun_tipo" text DEFAULT 'servidor' NOT NULL;--> statement-breakpoint
ALTER TABLE "funcionario" ADD COLUMN "fun_ativo" boolean DEFAULT true NOT NULL;--> statement-breakpoint
...
ALTER TABLE "departamentos" DROP COLUMN "dep_motivo";--> statement-breakpoint
ALTER TABLE "funcionario" ADD CONSTRAINT "funcionario_fun_email_unique" UNIQUE("fun_email");--> statement-breakpoint
ALTER TABLE "funcionario" ADD CONSTRAINT "funcionario_fun_cpf_unique" UNIQUE("fun_cpf");--> statement-breakpoint
ALTER TABLE "funcionario" ADD CONSTRAINT "funcionario_fun_login_unique" UNIQUE("fun_login");