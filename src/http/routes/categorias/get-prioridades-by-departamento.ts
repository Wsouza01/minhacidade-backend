...
export const getPrioridadesByDepartamentoRoute: FastifyPluginCallbackZod = (app) => {
  app.get(
    ...
    async (request, reply) => {
      ...
      if (depNome.includes('saúde') || depNome.includes('saude') || depNome.includes('emergência')) {
