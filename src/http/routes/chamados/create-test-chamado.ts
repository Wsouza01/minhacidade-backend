...
export const createTestChamadoRoute: FastifyPluginCallbackZod = (app) => {
  app.post(
    '/chamados/test/:cpf',
    {
      schema: {
      ...
      try {
        ...
        const novoChamado = await db
          ...
          .values({
            ...
            cha_descricao:
              'Poste de iluminação pública queimado na Rua Principal, altura do número 123. A rua está muito escura à noite, causando insegurança para os moradores.',
