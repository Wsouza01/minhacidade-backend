...
export const getSacOuvidoriaRoute: FastifyPluginCallbackZod = (app) => {
  app.get(
    '/sac-ouvidoria',
    {
      schema: {
        ...
        querystring: z.object({
          ...
          tipo: z.enum(['Elogio', 'Reclamação', 'Solicitação', 'Sugestão']).optional(),
        }),
      },
    },
    async (request, reply) => {
      ...
      try {
        console.log('📥 Buscando registros SAC/Ouvidoria:', { cidadeId, limite, offset, tipo })
